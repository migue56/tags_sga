...
from .views import ListSustanceView, CreateSustanceView, UpdateSustanceView, DeleteSustanceView
...
urlpatterns = [
     ...
     path('sustance/delete/<str:sustance_pk>/', DeleteSustanceView.as_view(), name='sustance_delete'),
]
